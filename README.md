...
We recommend creating a virtual environment, and since certain packages are better installed with conda instead of pip, we recommend installing all the conda packages all at once:

1. `conda create -n kiwiglider compliance-checker cc-plugin-glider gsw ioos_qc notebook`
1. `conda activate kiwiglider`

As of 26 May 2025, one dependency fails under pip but works with conda. As such, also do `conda install compliance-checker cc-plugin-glider gsw ioos_qc`
